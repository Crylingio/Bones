        ...
        private:
            ...
            const std::map<const std::string, const Consumable> table{
                ...
                },
                {
                    ...
                    Consumable("Normal Health Potion", "Heals 25 HP ", next_id++, 25, 0, 5, 3)
                }
            };
        public:
            // Generates a reference to an item in the table.
...
void weaponinv() {
    ...
    int index = 1;
    cout << "0) Exit" << endl;
    for (const auto& wep : Charac.inventory.getAll())
    {
        cout << index << ") " << wep.getItem()->getName() << std::endl;
        index++;
    }
    cin >> input;
    if (input == 0) {
        ...
        case 1:
            ...
            case 1:
                ...
                if (acchit > Charac.equipped->getAccuracy()) {
                    ...
                    if (randint < Charac.crt + Charac.equipped->getCrit()) {
                        randamage = rand() % Charac.equipped->getDamage() + Charac.str * Acc.headdamagex * 2;
                        ...
                        randamage = rand() % Charac.equipped->getDamage() + Charac.str * Acc.headdamagex;
            ...
            case 2:
                ...
                if (acchit > Charac.equipped->getAccuracy()) {
                    ...
                    randint = rand() % 100;
                    if (randint < Charac.crt + Charac.equipped->getCrit()) {
                        randamage = rand() % Charac.equipped->getDamage() + Charac.str * Acc.chestdamagex * 2;
                        cout << "You get a critical hit! Dealing " << randamage << " extra damage! \nAlso dealing " << bodydamage << "body damage." << endl;
                        Enemy.ehp = Enemy.ehp - randamage;
            ...
            case 3:
                ...
                if (acchit > Charac.equipped->getAccuracy()) {
                    ...
                    randamage = rand() % Charac.equipped->getDamage() + Charac.str * Acc.rightarmdamagex;
                    cout << "You hit the enemy, dealing " << randamage << " damage to the enemy,\nand dealing " << bodydamage << " body part damage" << endl;
                    Enemy.ehp = Enemy.ehp - randamage;
...
void blackmarket() {
    ...
    if (Charac.blackmarketfirst == false) {
        ...
        case 5:
            ...
            cout << "1) Normal Health Potion" << endl;
        }
    }
}
